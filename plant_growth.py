...
if st.sidebar.button("Predict"):
    input_df = preprocess_input(Sunlight_Hours, Temperature, Humidity, Soil_Type, Water_Frequency, Fertilizer_Type)
...
2. Provide values for Sunlight Hours, Temperature, and Humidity.
